...
We are a group of Senior Electrical Engineering students at the University of Utah. Together, we are implementing a case study in Agile Systems Engineering, which we believe has profound implications for changing the culture of technological innovation. "Hear-Yourself" is our project's nickname, reflective of the innovative mechanism of Agile Systems Engineering, which places utmost value on the customer's input. In order to extend this mechanism for realizing a change in innovative culture, we recognize the customer as a community of end-users. The goals and objectives of an individual user within this community are automatically "listened to" within an Agile framework, and the development of a technological product "responds" to those needs. Thus, as the individual announces their needs within the community, Agile Systems Engineering provides a means for technologically incorporating a response within a product, and the individual ultimately *hears themselves* within the final product.
